...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(30, 268);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(420, 268);
			...
			this->label1->Size = System::Drawing::Size(520, 20);
			this->label1->TabIndex = 2;
			this->label1->Text = L"Введите целое число(высота строки/ширина столбца)";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(163, 145);
